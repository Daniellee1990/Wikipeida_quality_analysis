...
svm_model_linear = SVC(kernel = 'linear', C = 1).fit(X_train, y_train_list)
svm_predictions = svm_model_linear.predict(X_test)
y_score_svm = svm_model_linear.decision_function(X_test)
plot_average_precision(Y_test, y_score_svm)
"""

"""
### KNN ####
knn = KNeighborsClassifier(n_neighbors = 7).fit(X_train, y_train_list) 
# creating a confusion matrix
knn_predictions = knn.predict(X_test)
y_score_knn = knn.predict_proba(X_test)
plot_average_precision(Y_test, y_score_knn)
"""
